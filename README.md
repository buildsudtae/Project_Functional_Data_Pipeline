...
ระบบรับไฟล์ CSV ต้นทาง แล้วผ่านกระบวนการแปลงค่า **3 ขั้นตอน (Step)** เพื่อสร้างคอลัมน์วิเคราะห์ใหม่ 3 คอลัมน์ จากนั้นส่งออกเป็นไฟล์ผลลัพธ์ 2 ชุด ได้แก่ **Sequential** และ **Concurrent** แล้วนำเวลาการประมวลมาเปรียบเทียบกัน
